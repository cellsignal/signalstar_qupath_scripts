...
def five_to_one = GeometryTools.convertTransform(
        new AffineTransformation([0.9999380111694336,	-0.013238528743386269,	120.06830892260743,
                                  0.013262579217553139,	0.9996398091316223,	-420.9795740895996
        ] as double[])).createInverse()

def six_to_one = GeometryTools.convertTransform(
        new AffineTransformation([0.9999380111694336,	-0.013238528743386269,	120.06830892260743,
                                  0.013262579217553139,	0.9996398091316223,	-420.9795740895996
        ] as double[])).createInverse()

def seven_to_one = GeometryTools.convertTransform(
        new AffineTransformation([0.9999380111694336,	-0.013238528743386269,	120.06830892260743,
                                  0.013262579217553139,	0.9996398091316223,	-420.9795740895996
        ] as double[])).createInverse()

def eight_to_one = GeometryTools.convertTransform(
        new AffineTransformation([0.9999380111694336,	-0.013238528743386269,	120.06830892260743,
                                  0.013262579217553139,	0.9996398091316223,	-420.9795740895996
        ] as double[])).createInverse()

def nine_to_one = GeometryTools.convertTransform(
        new AffineTransformation([0.9999380111694336,	-0.013238528743386269,	120.06830892260743,
                                  0.013262579217553139,	0.9996398091316223,	-420.9795740895996
        ] as double[])).createInverse()
